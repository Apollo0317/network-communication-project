...
class TestModulatorBasic(unittest.TestCase):
    ...
    def test_bits_to_bytes(self):
        ...
        test_bits = [0,1,0,1,0,1,0,1,  # 0x55
...
class TestErrorRateAnalysis(unittest.TestCase):
    ...
    def calculate_ber_ser(self, sent_data: bytes, recv_data: bytes) -> Tuple[float, float]:
        """
        ...
        bit_errors = sum(s != r for s, r in zip(sent_bits[:min_len], recv_bits[:min_len]))
    ...
    def test_combined_conditions(self):
        ...
        print("="*90)
        print(f"{'Description':<25} {'Len(m)':<8} {'Atten':<8} {'Noise':<8} {'BER':<12} {'SER':<12}")
        print("-"*90)
        ...
        for length, atten, noise, desc in test_cases:
            ...
            print(f"{desc:<25} {length:<8} {atten:<8.2f} {noise:<8.2f} {ber:<12.6f} {ser:<12.6f}")
